...
Une recette de rang $(m, n)$ est une relation de $\left(S\times C\right)^m$ dans $\left(S\times C\right)^m$ qui lie m doublets à n autre doublets. Une recette dont le rang n'est pas récisé est une recette de rang $(1, 1)$. Une recette est dite réalisable si et seulement si :
\begin{itemize}
