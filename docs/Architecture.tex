...
\begin{itemize}
\item Justifier pourquoi on a besoin de \texttt{ActivatedRecipe} et \texttt{Actor}.
\item Réécrire Recipe et bindedRecipe
\item si le temps, faire objet \texttt{userGroup}
\item changer \texttt{getActivatedRecipesByUser}
\end{itemize}
