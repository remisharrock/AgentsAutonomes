...
public final class AllMessages {
	...
	public static class Garage {
		...
		/**
		 * This Action will open the garage door you specify. If the garage door
		 * is already open, the door will remain open.
		 */
		...
		/**
		 * This Action will close the garage door you specify. If the garage
		 * door is already closed, the door will remain closed.
		 */
	...
	public static class Bttn {
		...
		/**
		 * This Trigger fires every time the bttn is pressed (or not pressed
		 * within time window). Configure bttn behavior at my.bt.tn.
		 */
	...
	public static class Manythings {
		...
		/**
		 * This Action will mute audio for recordings made on a device, so no
		 * audio is captured.
		 */
		...
		/**
		 * This Action will turn off mute audio, so that sound is captured when
		...
		/**
		 * This Action will switch your recording from a video stream to stills
		 * only mode, where still images are taken at regular intervals rather
		 * than video. Ideal for low bandwidth usage.
		 */
		...
		/**
		 * This Action will switch from ”Stills Only Mode” to a video stream.
		 * Note: your network bandwidth must be good enough to stream video, and
		 * the device may drop back to stills mode automatically if connection
		 * is poor.
		 */
		...
		/**
		 * This Action will sets the time interval between stills images. This
		 * value is only used when the phone is recording in stills mode.
		 */
		...
		/**
		 * This Action will set the motion sensitivity on a device. "1" triggers
		 * on small motion events. "10" triggers on big motion events.
		 */
		public static class SetMotionSensitivityThreshold implements Serializable {
			 ...
			 *            "1" triggers on small motion events. "10" triggers on
			 *            big motion events.
			 */
		...
		/**
		 * This Action will set a number of different camera settings at the
		 * same time. You don't need to set all the settings, and can leave some
		 * as "please select", so they remain unchanged on the device. NOTE: To
		 * start a new recording, the app must be open at the recording screen
		...
		/**
		 * This Trigger fires every time your Manything camera detects motion
		 * while recording. NOTE: set your camera's sensitivity threshold in the
		 * Manything app.
		 */
		...
		/**
		 * This Triggers when a device detects that its power has been
		 * disconnected.
		 */
